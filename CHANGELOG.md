...
<h2>Version 5.1.0 - ??/??/2026</h2>
      <ul>
        ...
        <li><i>[All APIs]</i> Added the <i>Show usage data in chat</i> option: each answer shows the tokens used, with a click opening the details (input, cached, output, reasoning, duration, context used and session total) [<a href="https://github.com/micz/ThunderAI/issues/496">#496</a>].</li>
