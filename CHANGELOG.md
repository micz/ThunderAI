...
<h2>Version 4.1.1 - ??/??/2026</h2>
      <ul>
        ...
        <li>Fix: correctly displaying the elaboration result related to the current email, even when the user is wating on the message pane fpr the result and many emails are in elaboration [<a href="https://github.com/micz/ThunderAI/issues/806">#806</a>].</li>
