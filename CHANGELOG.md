...
<h2>Version 5.0.0 - ??/??/2026</h2>
      <ul>
        ...
        <li><i>[All APIs]</i> Fix: no more extra empty lines between the AI answer and the signature or the quoted text when the answer is inserted in the mail. A fixed empty paragraph was added before the signature or the quote, leaving a large gap: now there is a single empty line [<a href="https://github.com/micz/ThunderAI/issues/849">#849</a>].</li>
