...
export const defaultPrompts = [
    ...
    { id: 'prompt_summarize_this', name: "__MSG_prompt_summarize_this__", text: "Summerize the following email into a bullet point list.", type: 0, action: 0, need_selected: 0, need_signature: 0 },
