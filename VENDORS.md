...
source: https://cdn.jsdelivr.net/npm/tom-select@v2.6.0/dist/js/tom-select.base.js

file: pages\_lib\tom-select.default.min.css
source: https://cdn.jsdelivr.net/npm/tom-select@v2.6.0/dist/css/tom-select.default.min.css
